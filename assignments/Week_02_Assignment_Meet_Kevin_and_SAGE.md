...
A. Option A: You are taking other programming classes ("code builders")
B. Option B: You don't consider yourself a programmer ("prompt crafters")
...
### Where to Get Help
1. **Course Communication**: Canvas or email

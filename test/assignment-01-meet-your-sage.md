...
5. Name it: **SAGE-CSC113**
6. Add a description: "My AI study assistant for CSC-113 AI Fundamentals"
...
3. Look for "Gem manager" in the left sidebar (or under the menu)
4. Click "New Gem"
5. Name it: **SAGE-CSC113**
6. Add instructions: "You are SAGE, my study assistant for CSC-113 AI Fundamentals"
...
2. Look for "Project knowledge" or the ability to add files
3. Upload or paste the contents of `SAGE-core.md`

**For Gemini Gems:**
1. Open your SAGE-CSC113 gem for editing
2. In the "Instructions" section, paste the contents of `SAGE-core.md`
3. Save your gem
...
2. "What's the main project I'll be building in this course?"

3. "I'm nervous about using GitHub. What should I know?"

4. "What happens if I break something in this class?"

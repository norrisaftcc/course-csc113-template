...
This guide covers instructor operations for:

WEEK 1 - Hello GitHub
- Section 2.0 (Pre-semester setup)
- Section 3.0 (Tutorial Level)
- GitHub organization creation
- First day ceremonies

WEEK 2 - Meet Kevin & SAGE  
- Section 4.0 (Week 2 Assistant Factory)
- Daily standup implementation
- Rate limit management
- Quality assurance processes

WEEKS 3-6 - Bot Development & Specialization
- Section 4.0 (Specialization Split)
- Track management systems
- Prompt Masters vs Code Builders support

WEEKS 7-8 - Community Projects
- Section 4.0 (Final Boss Rush)
- Partner coordination
- Presentation management
- Demo day logistics

ALL WEEKS - Core Operations
- Section 5.0 (Boss Fights / Crisis Management)
- Section 6.0 (Hidden Mechanics)
- Section 7.0 (Speedrun Strats / Daily Operations)
- Section 8.0 (Assessment / 100% Completion)
